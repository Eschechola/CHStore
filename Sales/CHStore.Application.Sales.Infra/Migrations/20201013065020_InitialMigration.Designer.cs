...
namespace CHStore.Application.Sales.Infra.Migrations
{
    ...
    [Migration("20201013065020_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CHStore.Application.Sales.Domain.Entities.Coupon", b =>
                {
                    ...
                    b.Property<DateTime>("FinalDate")
                        ...
                        .HasDefaultValue(new DateTime(2020, 10, 13, 3, 50, 20, 555, DateTimeKind.Local).AddTicks(4535));

                    b.Property<DateTime>("InitialDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("InitialDate")
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2020, 10, 13, 3, 50, 20, 554, DateTimeKind.Local).AddTicks(4238));
            ...
            modelBuilder.Entity("CHStore.Application.Sales.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("RequestDate")
                        ...
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2020, 10, 13, 3, 50, 20, 563, DateTimeKind.Local).AddTicks(5639));
            ...
            modelBuilder.Entity("CHStore.Application.Sales.Domain.Entities.Status", b =>
                {
                    ...
                    b.Property<DateTime>("DateModified")
                        ...
                        .HasColumnType("DATETIME")
                        .HasDefaultValue(new DateTime(2020, 10, 13, 3, 50, 20, 564, DateTimeKind.Local).AddTicks(2791));
            ...
            modelBuilder.Entity("CHStore.Application.Sales.Domain.Entities.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CHStore.Application.Sales.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("CHStore.Application.Sales.Domain.Entities.User", "User")
                        .WithMany("Orders")
